...
//        StorageReference filePath = PostsImagesRefrence.child("Post Images").child(currentUserID + ".jpg");

//        StorageReference filePath = PostsImagesRefrence.child("Post Images").child(ImageUri.getLastPathSegment() + postRandomName + ".jpg");

        StorageReference filePath = PostsImagesRefrence.child("Post Images").child("Image-" + postRandomName + ".jpg");
